...
This script is used to cross validate the vae model with the full measurement set. Cross validations are performed
separately for each latent dimension size.
